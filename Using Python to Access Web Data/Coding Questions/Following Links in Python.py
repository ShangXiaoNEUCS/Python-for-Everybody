...
# particular position relative to the first name in the list,
# ollow that link and repeat the process a number of times and report the last name you find.
...
# Actual problem: Start at: http://py4e-data.dr-chuck.net/known_by_Rebbecah.html
...
# make it difficult for you to do the assignment without writing a Python program.
# But frankly with a little effort and patience you can overcome these attempts to
# make it a little harder to complete the assignment without writing a Python program.
